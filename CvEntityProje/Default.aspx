...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Mustafa Aktaş</a></h1>
            <p class="top_hdp mt-2">Bilgisayar Mühendisliği 4. Sınıf Öğrencisi</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#news" class="scroll">İş Deneyimlerim</a></li>
    ...
    <div class="main">
        ...
        <section class="services" id="services">
            <div class="container">
                ...
                <p class="iner mt-md-5 text-left">Deneme </p>
